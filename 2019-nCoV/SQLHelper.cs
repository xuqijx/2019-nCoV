...
namespace _2019_nCoV
{
    public class SQLHelper
    {
        //连接字符串
        static string strConn = "server=192.168.0.2;database=xq_test;uid=sa;pwd=AHq2w3e4.r5;";
        //static string strConn = "server=localhost;database=Test;uid=sa;pwd=123456;";
